...
const dataPageInfo: IPageInfo[] = [
	...
	},
	{
		...
		text: 'Я люблю писать код, особенно те моменты, когда первая же идея при проверке сразу работает идеально. Также мне нравится дух соперничества. Поэтому, если есть возможность участвовать в хакатоне, я всегда принимаю это предложение.',
	},
	{
		//yellow
		id: 3,
